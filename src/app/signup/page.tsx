...
export const metadata: Metadata = {
  title: "Sign Up Page | Free Next.js Template for TalentTech and SaaS",
  description: "This is Sign Up Page for TalentTech Nextjs Template",
  // other metadata
};
