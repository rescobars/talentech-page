...
export const metadata: Metadata = {
  title: "Blog Details Page | Free Next.js Template for TalentTech and SaaS",
  description: "This is Blog Details Page for TalentTech Nextjs Template",
  // other metadata
};
